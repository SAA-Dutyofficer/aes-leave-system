export const LEAVE_TYPES = [
  ...
  "Emergency Leave","Compassionate Leave","National Service","Exam Leave"
];
...
export const ROLES = {
  staff:"Staff", officer:"Officer", fire_admin:"Fire Admin", head_ops:"Head of Operations"
};
...
export function statusBadge(status) {
  const map = {
    Pending:"sb-pending","Approved (Officer)":"sb-officer",
    "Approved (Admin)":"sb-admin",Approved:"sb-approved",
    Rejected:"sb-rejected",Cancelled:"sb-cancelled"
  };
